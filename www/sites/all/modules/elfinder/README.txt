$Id: README.txt,v 1.2.4.3 2010/12/11 20:13:56 ph0enix Exp $
...
Optional:
 ...
 - Wysiwyg module
 - Wysiwyg API capable editor:
 
    - CKEditor
    - FCKeditor
    - TinyMCE 3
    - BUEdtor (Drupal 6.x with installed wysiwyg_bueditor module, http://drupal.org/node/429684#comment-1462472)
    - jWYSIWYG (Drupal 6.x, jWYSIWYG 0.93+, jquery 1.3+, jquery ui 1.7+)
    - YUI Editor (Drupal 6.x)
    - WYMeditor
...
Installation:
  ...
  3. Enable elFinder module in Site Building > Modules
  4. Add 'use file manager' permission to users who will be able to use elFinder at User Management > Permissions
  5. Enable elFinder checkbox in your editor Wysywyg profile at Site Configuration > Wysiwyg > <Editor Profile> > Buttons and Plugins
...
Known Issues:
 ...
 - Editors supported only through wysiwyg module (so standalone ckeditor, tinymce, bueditor, etc module not supported)
